...
public class GameHistoryPanel extends JPanel
{
    ...
    * */
              ...
              final MoveLog moveHistory)
    {
        ...
        /*
        * This is set up so that if the move log has more items then can fit in the window then a
        * vertical scroll bar will appear in order to see all of the moves in moveLog
        * */
    ...
    // Sub-Classes:
    /*
    * What does private static mean in a class heading?
    *
    * */
    private static class DataModel extends DefaultTableModel
    {
                               ...
                               final int column)
        {
            ...
            if(column == 0) // adding a row
            {
                currentRow.setWhiteMove((String)aValue);
                fireTableRowsInserted(row, row);
            }
            else if(column == 1) // updating a col
            {
